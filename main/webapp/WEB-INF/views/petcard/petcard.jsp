                ...
                <div class="border">
                    ...
                    <c:forEach items="${listOfPetWeight}" var="petWeight">
                    	<div class="border" style=" position: relative;">
                    		<p> 입력날짜 : ${ petWeight.petWeightDate } </p>
                    		<p> 몸무게 : ${ petWeight.petWeight }	</p>
           	        	<div class="update">
                           <a href="#" class=" m-1 p-1 border text-white btn btn-success">수정하기</a>
                       	</div>
                       
	                    <div class="col-sm-1" style="position: absolute; top: 45%; transform: translateX(905%);">
	                        <a href="${pageContext.request.contextPath}/login/deleteWeghit?petId=${petid.petId}" class="p-3 border text-secondary"> <i class="fa-solid fa-trash-can"></i> </a>
	                     </div>
                       </div>
                    </c:forEach>
	     			...
	     			<form action="${pageContext.request.contextPath}/login/petcard" method="post">
	                    ...
	                    <input class="bg-dark text-white border border-radios" type="submit" />
	                </form>
             	</div>
                        ...
                        <div id="ChartDetails1"  style="display: none;">
                      	 ...
                      	 <c:forEach items="${listOfPetChard}" var="petcard" >
                        	<div class="border" style=" position: relative;">
                                ...
                                <div class="col-sm-1" style="position: absolute; top: 45%; transform: translateX(905%);">
                                    <a href="#" class="p-3 border text-secondary"><i class="fa-solid fa-trash-can"></i></a>
                                </div>
                    ...
                    <td>
                        ...
                        <c:forEach items="${listOfpetVaccination}" var="petcard">
                        	...
                        	<div class="border"  style=" position: relative;">
                                ...
                                <div class="col-sm-1" style="position: absolute; top: 45%; transform: translateX(905%);">
                                    <a href="${pageContext.request.contextPath}/login/deleteVaccination?petId=${petid.petId}" class="p-3 border text-secondary"><i class="fa-solid fa-trash-can"></i></a>
                                </div>

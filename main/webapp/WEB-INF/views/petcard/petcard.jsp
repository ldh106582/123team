                       ...
                       <td>
                        ...
                        <div id="ChartDetails1"  style="display: none;">
                          <c:forEach items="${petcards}" var="petcard">
                           <div class="border" id="petcard" style="position: relative;">
                              ...
                              <p> 진료내용 : ${petcard.petChartContent}</p>
                                ...
                                <div style="position: absolute; top: 35%; transform: translateX(905%);">
                            ...
                            <form action="./hopitalpetcard?petCard=${pet.petId}" method="post">
                                <div class="border" id="petcard" style="position: relative;"></div>

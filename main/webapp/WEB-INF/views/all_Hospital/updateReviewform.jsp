		      ...
		      <div class="row w-100 mx-0">
		        <div class="col-lg-6 mx-auto">
		          <div class="col-md-7 no-gutters" style="margin-left: 25%;">
		            <h1 class="col-md-12 text-center mb-5" style="color: rgb(140, 58, 179);">리뷰수정 하기</h1>
		            <div class="show-gird col-md-12 mb-4">
						 <form:form modelAttribute="review" method="POST" enctype="multipart/form-data">
						    ...
						    <div class="col-md-12 p-0 mb-3">
						        ...
						        <form:input class="form-control form-control-lg col-md-12" style="justify-content: center;" path="title" value="${review.title}"/>
						    </div>
						    <div class="col-md-12 no-gutters p-0 mb-3">
						        <h4 class=" col-md-12 p-0" style="color: rgb(140, 58, 179);">내용</h4>
						        <form:input class="form-control form-control-lg col-md-12" path="context" value="${review.context}"/>
						    </div>
						    <div class="col-md-12 p-0 mb-3">
